// Project2Task4.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main(int argc, char** argv)
{
    ...
    Mat image = imread("C:/Users/srika/Downloads/olympus/olympus/pic.0535.jpg");
